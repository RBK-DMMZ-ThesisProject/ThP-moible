...
class SignIn extends React.Component<Props, object> {
    ...
    render() {
        const { navigation } = this.props;
        const { email, password, signInLoading, emailError, passwordError, loginError } = this.state;
        return (
            <>
                ...
                <SafeAreaView style={{ flex: 1 }}>
                    <ScrollView style={{ flex: 1, backgroundColor: '#fff' }}>
                        ...
                        <Text style={{ fontSize: 16, lineHeight: 20, color: '#67A443', textAlign: 'center' }} > Don't You Have an Account?</Text>
                        <View style={{ flex: 1, margin: 10 }}>
                            <Button buttonStyle={{
                                backgroundColor: '#078ca9',
                                width: 100 + "%",
